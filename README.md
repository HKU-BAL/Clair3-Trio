...
## Latest Updates
*v0.7 (July 9, 2023)*: Added source/version/command tag into VCF header. Fixed a bug of AF for 1/2 genotypes. Added AD into VCF output. Added document about [output](#output-files) files. Added a [page](docs/trio/merge.md) for the method of merging VCF.
